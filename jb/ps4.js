...
function setupRW() {
	...
	debug_log("");
	msgs.innerHTML="\n <h1 style='text-align:center;color:blue;'><b>DESBLOQUEIO REALIZADO COM SUCESSO !!!</b></h1> \n \n <h2 style='text-align:center;color:red;'>AGUARDE ATÉ APARECER A MENSAGEM DE BOA VINDAS DO PS4HEN v2.1.3, DEPOIS SAIA USANDO O \"CIRCULO\". <h2> \n";
